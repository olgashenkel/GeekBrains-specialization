...
public class Task_1 {
    public static void main(String[] args) {
        ...
        int num = 5;
        int element = 55;
//        System.out.println(array(arr, num, element));

        if (array(arr, num, element) == -1) {
            System.out.printf("Длина массива меньше %d", num);
        } else if (array(arr, num, element) == -2) {
            System.out.printf("Елемент %d не найден", element);
        } else if (array(arr, num, element) == -3) {
            System.out.println("Массив пуст");
        } else {
            System.out.println("Индекс найденного элемента: " + array(arr, num, element));
        }

    }

    public static int array(int[] arr, int num, int element) {
